        ...
        <div class="ticket-info-container">
            <div class="ticket-info-left-container">
                ...
                <div class="ticket-info-left-genre-container">
                    ...
                    <div>Sci-fi, Adventure, Drama</div>
                </div>
            </div>
            <div class="ticket-info-right-container">
                ...
                <div class="ticket-info-right-seating-container">
                    ...
                    <div class="ticket-info-right-seating-available">Available Seats 96</div>
                ...
                <div class="ticket-info-right-purchase-container">
                    <div class="ticket-info-right-purchase-amount">
                        <div>Enter the number of seats to be booked</div>
                        <div class="ticket-info-right-purchase-adjust">
                            <div class="button-operator minus">
                                <button>-</button>
                            </div>
                            ...
                            <div class="button-operator plus">
                                <button>+</button> 
                            </div>
                        </div>
                    </div>
                    <div class="button-next">
                        <a href="/payment"><img src="/public/icons/bookin-button-next.svg" alt="Next Button" /></a>
                    </div>
                </div>
            </div>
        </div>
